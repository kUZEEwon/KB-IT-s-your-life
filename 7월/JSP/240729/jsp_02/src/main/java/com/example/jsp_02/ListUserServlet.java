...
public class ListUserServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		out.println("<tr>");
		out.println("<th bgcolor='lightgray' width='100'>아이디</th>");
		out.println("<th bgcolor='lightgray' width='200'>패스워드</th>");
		out.println("<th bgcolor='lightgray' width='150'>이름</th>");
		out.println("<th bgcolor='lightgray' width='150'>역할</th>");
		out.println("</tr>");
