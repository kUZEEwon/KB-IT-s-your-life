...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(AuthenticationManagerBuilder auth)
      ...
      /*  auth.inMemoryAuthentication()
        ...
        // 구현 부분
        // UserDetailsService와 PasswordEncoder를 사용한 인증 설정
        auth.userDetailsService(userDetailsService)  // UserDetailsService를 사용하여 사용자 정보 로드
                .passwordEncoder(passwordEncoder());  // PasswordEncoder를 사용하여 비밀번호 암호화
